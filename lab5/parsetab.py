...
_lr_productions = [
  ...
  ('program -> statement ; program','program',3,'p_program','reptilian.py',112),
  ('program -> block program','program',2,'p_program','reptilian.py',113),
  ('program -> statement ;','program',2,'p_program','reptilian.py',114),
  ('program -> block','program',1,'p_program','reptilian.py',115),
  ('block -> { program }','block',3,'p_block','reptilian.py',125),
  ('statement -> expr','statement',1,'p_statement_expr','reptilian.py',133),
  ('statement -> PRINT rvalue','statement',2,'p_statement_print','reptilian.py',137),
  ('statement -> boolean','statement',1,'p_statement_relation','reptilian.py',141),
  ('statement -> DEF NAME ( arglist ) block','statement',6,'p_statement_fundef','reptilian.py',145),
  ('statement -> DEF NAME ( ) block','statement',5,'p_statement_fundef','reptilian.py',146),
  ('arglist -> arg , arglist','arglist',3,'p_arglist','reptilian.py',153),
  ('arglist -> arg','arglist',1,'p_arglist','reptilian.py',154),
  ('arg -> typename NAME','arg',2,'p_arg','reptilian.py',164),
  ('statement -> call','statement',1,'p_statement_call','reptilian.py',169),
  ('call -> RUN NAME ( )','call',4,'p_call','reptilian.py',173),
  ('call -> RUN NAME ( rvallist )','call',5,'p_call','reptilian.py',174),
  ('rvallist -> rvalue , rvallist','rvallist',3,'p_rvallist','reptilian.py',183),
  ('rvallist -> rvalue','rvallist',1,'p_rvallist','reptilian.py',184),
  ('statement -> IF ( boolean ) block','statement',5,'p_statement_cond','reptilian.py',194),
  ('statement -> WHILE ( boolean ) block','statement',5,'p_statement_while','reptilian.py',200),
  ('statement -> FOR ( statement ; boolean ; statement ) block','statement',9,'p_statement_for','reptilian.py',205),
  ('boolean -> relation','boolean',1,'p_boolean','reptilian.py',213),
  ('boolean -> BOOLEAN','boolean',1,'p_boolean','reptilian.py',214),
  ('boolean -> boolean logicop boolean','boolean',3,'p_boolean','reptilian.py',215),
  ('logicop -> AND','logicop',1,'p_logicop','reptilian.py',219),
  ('logicop -> OR','logicop',1,'p_logicop','reptilian.py',220),
  ('logicop -> NAND','logicop',1,'p_logicop','reptilian.py',221),
  ('logicop -> NOR','logicop',1,'p_logicop','reptilian.py',222),
  ('relation -> rvalue RELOP rvalue','relation',3,'p_relation','reptilian.py',227),
  ('typename -> INT','typename',1,'p_typename','reptilian.py',231),
  ('typename -> FLOAT','typename',1,'p_typename','reptilian.py',232),
  ('typename -> STRING','typename',1,'p_typename','reptilian.py',233),
  ('rvalue -> expr','rvalue',1,'p_rvalue','reptilian.py',237),
  ('rvalue -> boolean','rvalue',1,'p_rvalue','reptilian.py',238),
  ('rvalue -> number','rvalue',1,'p_rvalue','reptilian.py',239),
  ('rvalue -> block','rvalue',1,'p_rvalue','reptilian.py',240),
  ('rvalue -> call','rvalue',1,'p_rvalue','reptilian.py',241),
  ('statement -> typename NAME = rvalue','statement',4,'p_declaration','reptilian.py',245),
  ('statement -> NAME = rvalue','statement',3,'p_statement_assignment','reptilian.py',249),
  ('expr -> name','expr',1,'p_expr','reptilian.py',257),
  ('expr -> number','expr',1,'p_expr','reptilian.py',258),
  ('expr -> string','expr',1,'p_expr','reptilian.py',259),
  ('expr -> name expr','expr',2,'p_expr','reptilian.py',260),
  ('expr -> number expr','expr',2,'p_expr','reptilian.py',261),
  ('expr -> string expr','expr',2,'p_expr','reptilian.py',262),
  ('expr -> sinop expr','expr',2,'p_expr','reptilian.py',263),
  ('expr -> binop expr','expr',2,'p_expr','reptilian.py',264),
  ('expr -> sinop','expr',1,'p_expr','reptilian.py',265),
  ('expr -> binop','expr',1,'p_expr','reptilian.py',266),
  ('sinop -> FUNCTION','sinop',1,'p_sinop','reptilian.py',273),
  ('binop -> BINOP','binop',1,'p_binop','reptilian.py',277),
  ('name -> NAME','name',1,'p_var','reptilian.py',281),
  ('string -> STRING_T','string',1,'p_string','reptilian.py',285),
  ('integer -> INT_T','integer',1,'p_integer','reptilian.py',289),
  ('float -> FLOAT_T','float',1,'p_float','reptilian.py',293),
  ('number -> float','number',1,'p_number','reptilian.py',297),
  ('number -> integer','number',1,'p_number','reptilian.py',298),
]
